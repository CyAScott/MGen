...
{
    [DebuggerStepThrough]
    public static ForeachLoopBuilder AddForeachLoop(this BlockOfCodeBase parent, string elementType, Code elementVariableName, Code enumerable) => parent
        .Add(new ForeachLoopBuilder(parent, elementType, elementVariableName, enumerable));

    [DebuggerStepThrough]
    public static ForeachLoopBuilder AddForeachLoop(this BlockOfCodeBase parent, Code elementVariableName, Code enumerable) => parent
...
{
    internal ForeachLoopBuilder(BlockOfCodeBase parent, string elementType, Code elementVariableName, Code enumerable)
        : base(parent)
    {
    ...
    protected override void AppendHeader(StringBuilder stringBuilder) =>
        stringBuilder
            ...
            .Append("foreach (")
            .Append(Type).Append(' ').AppendCode(Name).Append(" in ")
